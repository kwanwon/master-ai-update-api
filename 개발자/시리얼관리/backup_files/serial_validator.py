...
def validate_serial_number(serial_number):
    ...
    try:
        cursor.execute('''
            SELECT is_blacklisted, expiration_date, is_active, device_id FROM serial_numbers
            WHERE serial_number = ?
        ''', (serial_number,))
...
def renew_serial_number(serial_number):
    ...
    try:
        ...
        new_expiration_date = expiration_date + timedelta(days=30)  # 갱신 시 30일 연장
